    ...
    return (
        <div style={{ position: 'absolute', left: '20%', top: '5%', transform: 'translate(-50%, -50%)' }}>
            <div style={{ width: '80%', maxWidth: '600px', position: 'relative' }}>
                ...
                <div style={{ ...commonTextStyle, fontSize: 18, color: '#4A5568', fontWeight: '500', width: 195.15, height: 22.47, left: 213.69, top: 610.75, position: 'absolute' }}>Register New Account</div>
