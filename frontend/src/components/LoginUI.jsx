    ...
    return (
        <div style={{ position: 'absolute', left: '20%', top: '5%', transform: 'translate(-50%, -50%)' }}>
            <div style={{ width: '80%', maxWidth: '600px', position: 'relative' }}>
                ...
                <div style={{ left: 180, top: 580, position: 'absolute', color: 'black', fontSize: 16, fontFamily: 'Roboto', fontWeight: '400', width: '300px' }}>Forgot password? Click here to reset</div>
