    ...
    return (
        <div style={{ position: 'absolute', left: '20%', top: '5%', transform: 'translate(-50%, -50%)' }}>
            <div style={{ width: '80%', maxWidth: '600px', position: 'relative' }}>
                ...
                <div style={{ width: 439.37, height: 53.50, left: 90.49, top: 595.70, position: 'absolute', background: 'white', border: '1px #4A5568 solid' }} />
                <div style={{ ...commonTextStyle, fontSize: 18, color: '#4A5568', fontWeight: '500', width: 195.15, height: 22.47, left: 230, top: 613.75, position: 'absolute' }}>Register New Account</div>

                <div style={{ left: 180, top: 560, position: 'absolute', color: 'black', fontSize: 16, fontFamily: 'Roboto', fontWeight: '400', width: '300px' }}>Forgot password? Click here to reset</div>
