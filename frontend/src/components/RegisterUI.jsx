...
const RegisterUI = () => {
    ...
    return (
        <div style={{width: '100%', height: '100%', position: 'relative'}}>
            <div style={{width: 584, height: 247, left: 282, top: 99, position: 'absolute', background: '#EDF2F7'}} />
            <div style={{width: 490.61, height: 542.47, left: 360.50, top: 130.53, position: 'absolute', background: '#667EEA', boxShadow: '0px 6px 12px rgba(0, 0, 0, 0.12)'}} />
            <div style={{width: 490.61, height: 542.47, left: 347, top: 123, position: 'absolute', background: 'white', boxShadow: '6px 0px 12px rgba(0, 0, 0, 0.12)'}} />

            {/*Heading*/}
            <img style={{width: 79.59, height: 53.50, left: 552, top: 123, position: 'absolute'}} src="https://via.placeholder.com/80x53" />
            <div style={{left: 527, top: 180, position: 'absolute', color: '#667EEA', fontSize: 36, fontFamily: 'Roboto', fontWeight: '700', wordWrap: 'break-word'}}>Register</div>
            <div style={{left: 483, top: 226, position: 'absolute', color: '#4A5568', fontSize: 18, fontFamily: 'Roboto', fontWeight: '400', wordWrap: 'break-word'}}>Register your account today</div>
            ...
            <div style={{width: 439.37, height: 53.50, left: 372, top: 542, position: 'absolute', background: '#667EEA'}} />
            <div style={{width: 439.37, height: 53.50, left: 375, top: 603, position: 'absolute', background: 'white', border: '1px #4A5568 solid'}} />
            ...
            <div style={{left: 547, top: 555, position: 'absolute', color: 'white', fontSize: 24, fontFamily: 'Roboto', fontWeight: '500', wordWrap: 'break-word'}}>Register</div>
            ...
            <div style={{left: 1045, top: 11, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Roboto', fontWeight: '500', wordWrap: 'break-word'}}>Login</div>
            <div style={{left: 775, top: 13, position: 'absolute', color: 'white', fontSize: 24, fontFamily: 'Roboto', fontWeight: '500', wordWrap: 'break-word'}}>Back to Home</div>
            <div style={{left: 457, top: 616, position: 'absolute', color: '#4A5568', fontSize: 24, fontFamily: 'Roboto', fontWeight: '500', wordWrap: 'break-word'}}>Have an account? Sign in</div>
