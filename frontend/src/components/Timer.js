      ...
      >
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <input
            ...
            style={{ position: 'absolute', top: 190, left: 50, width: '50px', textAlign: 'center', fontSize: '42px', background: '#EA7331', fontFamily: 'Poppins', fontWeight: '400' }}
            disabled={inputsDisabled}
          />
          ...
          <input
            ...
            style={{ position: 'absolute', top: 190, left: 150, width: '50px', textAlign: 'center', fontSize: '42px', background: '#EA7331', fontFamily: 'Poppins', fontWeight: '400' }}
            disabled={inputsDisabled}
          />
          ...
          <input
            ...
            style={{ position: 'absolute', top: 190, left: 255, width: '50px', textAlign: 'center', fontSize: '42px', background: '#EA7331', fontFamily: 'Poppins', fontWeight: '400' }}
            disabled={inputsDisabled}
          />
        </div>
