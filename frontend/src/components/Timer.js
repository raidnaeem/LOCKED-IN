    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', marginTop: '10px' }}>
          <div style={{ position: 'absolute', top: 232, left: 55, fontSize: '28px', color: 'white', fontFamily: 'Poppins', fontWeight: '400', marginRight: '20px' }}>hrs</div>
          <div style={{ position: 'absolute', top: 232, left: 145, fontSize: '28px', color: 'white', fontFamily: 'Poppins', fontWeight: '400', marginRight: '20px' }}>mins</div>
          <div style={{ position: 'absolute', top: 232, left: 250, fontSize: '28px', color: 'white', fontFamily: 'Poppins', fontWeight: '400' }}>secs</div>
        </div>
